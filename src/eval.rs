...
impl Evaluator {
    ...
    pub fn eval<'a>(&self, captures: &Captures<'a>, t: &'a Term) -> Rc<Value<'a>> {
        match t {
            ...
            Term::If(t1, t2, t3) => {
                ...
                if let Value::VBool(b) = &*v1 {
                    if *b {
                        self.eval(captures, t2)
                    } else {
                        self.eval(captures, t3)
                    }
                } else {
